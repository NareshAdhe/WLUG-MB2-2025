      ...
      <div className="bg-black min-h-[300vh] w-full text-white relative overflow-hidden">
        ...
        <img
          ...
          style={{
            ...
            height:
              window.innerWidth <= 473 && window.innerHeight <= 857
                ? "150px"
                : undefined,
            width:
              window.innerWidth <= 473 && window.innerHeight <= 857
        ...
        <div className="">
          <img
            ...
            style={{
              ...
              transform:
                window.innerWidth <= 473 && window.innerHeight <= 857
                  ? `translateX(${Math.max(-30, -getTransformX(0.09))}%)`
                  : `translateX(${Math.max(-40, -getTransformX(0.05))}%)`,
            }}
          />

          <img
            src="src/assets/vally_two.png"
            alt=""
            className="absolute z-[1000] "
            style={{
              top:
              ...
              transform:
                window.innerWidth <= 473 && window.innerHeight <= 857
                  ? `translateX(${Math.min(30, getTransformX(0.09))}%)`
                  : `translateX(${Math.min(40, getTransformX(0.05))}%)`,
            }}
          />

          <div className="absolute bottom-16 z-3000 w-full">
            <Registration />
            <Footer />
          </div>
        </div>
